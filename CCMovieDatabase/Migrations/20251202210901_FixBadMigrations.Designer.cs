...
namespace CCMovieDatabase.Migrations
{
    ...
    [Migration("20251202210901_FixBadMigrations")]
    partial class FixBadMigrations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CCMovieDatabase.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ThumbnailURL = "https://upload.wikimedia.org/wikipedia/en/thumb/f/fb/Men_in_Black_Poster.jpg/250px-Men_in_Black_Poster.jpg",
                            Title = "Men in Black"
                        },
                        new
                        {
                            ...
                            ThumbnailURL = "data:image/jpeg;base64,",
                        ...
                        new
                        {
                            ...
                            ThumbnailURL = "data:image/jpeg;base64,",
                            Title = "Monsters, Inc."
                        });
                });
